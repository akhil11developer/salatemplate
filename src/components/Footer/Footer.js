  ...
  return (
    <Container>
      <Grid container spacing={2} className="footer_grid">
        <Grid item md={3} xs={12} sm={4} sx={{ background: "" }}>
          <Box>
            ...
            <Typography sx={{ fontFamily: "Poppins" }}>
              A amazing WordPress theme designed specifically for a  astartup,
              apps, business, SaaS, and IT services.
            </Typography>
          </Box>
        </Grid>
        <Grid item md={2} xs={12} sm={2.66} sx={{ background: "" }}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>About us</Typography>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Blog</Typography>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Carrers</Typography>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Contact</Typography>
            </Box>
          </Box>
        </Grid>
        <Grid item md={2} xs={12} sm={2.66} sx={{ background: "" }}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Services</Typography>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Help Center</Typography>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Partners</Typography>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Privacy Policy</Typography>
            </Box>
          </Box>{" "}
        </Grid>
        <Grid item md={2} xs={12} sm={2.66} sx={{ background: "" }}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Facebook</Typography>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Twitter</Typography>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Instagram</Typography>
              <Typography className="link" sx={{ fontFamily: "Poppins" }}>Linkedin</Typography>
            </Box>
          </Box>{" "}
        </Grid>
        <Grid item md={3} xs={12} sm={6} sx={{ background: "" }}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            <Typography
              sx={{ fontSize: 18, fontWeight: 600, fontFamily: "Poppins" }}
            >
